...
export default function Student_dashborad() {
  ...
  return (
    ...
    <section className=" justify-center ml-[300px]  container mt-2   ">
              ...
              <div onClick={() => SendPK(item)} className=" services">
                <div className="face face1">
                  <div className="content ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="ml-4 w-16 h-16">
                ...
                <div className="face face2">
                  <div className="content mt-[100px]">
                    <p>{item.grade_level} at  {item.time}</p>
