                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full">
                                <thead class="bg-darker border-b">
                                    <tr>
                                        <th scope="col" class="rounded-tl-2xl hovertext-sm font-medium text-white px-6 py-4 text-left">
                                            #
                                        </th>
                                        ...
                                        <th scope="col" class="rounded-tr-2xl text-sm font-medium text-white px-6 py-4 text-left">
                                            IG
                                        </th>
                                    </tr>
                                </thead>
